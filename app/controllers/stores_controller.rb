class StoresController < ApplicationController
  ...
  def show
    conn = ActionCable.server.connections
    @shoes = Shoe.all
    @stock = Stock.all #there is relation but want to just do back end connection
  end
  ...
  private
    ...
    def store_params
      params.require(:store).permit(:name, :shoe, :stock)
    end
end
